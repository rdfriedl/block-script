...
<div>
	...
	<!-- github corner -->
	<a href="https://github.com/rdfriedl/block-script" class="github-corner">
		<svg width="80" height="80" viewBox="0 0 250 250" style="fill:#151513; color:#2b3e50; position: absolute; top: 0; border: 0; right: 0;">
	...
	<div class="flex-v" style="align-items: center">
		...
		<div class="col-xs-12 col-sm-8 col-md-6 col-lg-4" style="margin: 40px 0;">
			<router-link to="/play"><button type="button" class="btn btn-lg btn-block btn-success"><i class="fa fa-gamepad"></i> Play</button></router-link>
			<router-link to="/editor"><button type="button" class="btn btn-lg btn-block btn-info"><i class="fa fa-cubes"></i> Editor</button></router-link>
			<router-link to="/help"><button type="button" class="btn btn-lg btn-block btn-default"><i class="fa fa-question"></i> Help</button></router-link>
			<router-link to="/settings"><button type="button" class="btn btn-lg btn-block btn-default"><i class="fa fa-cogs"></i> Settings</button></router-link>
			<router-link to="/credits"><button type="button" class="btn btn-lg btn-block btn-default"><i class="fa fa-bars"></i> Credits</button></router-link>
		</div>
	</div>
