	...
	<div class="col-xs-12 col-md-6 col-md-offset-3">
		<div role="tabpanel">
		  	...
		  	<ul class="nav nav-tabs" role="tablist">
		  	  	<router-link tag="li" to="/help" active-class="active" exact><a><i class="fa fa-question"></i> General</a></router-link>
		  	  	<router-link tag="li" to="/help/game" active-class="active"><a><i class="fa fa-gamepad"></i> In-Game</a></router-link>
		  	  	<router-link tag="li" to="/help/maps" active-class="active"><a><i class="fa fa-picture-o"></i> Maps</a></router-link>
		  	</ul>

		  	<hr>

		  	<!-- Tab panes -->
	  	  	<div v-show="$route.params.topic == ''">
	  	  	</div>
	  	  	<div v-show="$route.params.topic == 'game'">
	  	  	...
	  	  	<div v-show="$route.params.topic == 'maps'">
	  	  		<ul class="pager">
