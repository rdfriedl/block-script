...
Noise.prototype.grad3 = [new Grad(1,1,0),new Grad(-1,1,0),new Grad(1,-1,0),new Grad(-1,-1,0),
             new Grad(1,0,1),new Grad(-1,0,1),new Grad(1,0,-1),new Grad(-1,0,-1),
             new Grad(0,1,1),new Grad(0,-1,1),new Grad(0,1,-1),new Grad(0,-1,-1)];

Noise.prototype.p = [151,160,137,91,90,15,
...
Noise.prototype.perm = new Array(512);
Noise.prototype.gradP = new Array(512);
...
for(var i=0; i<256; i++) {
  ...
  this.gradP[i] = this.gradP[i + 256] = grad3[this.perm[i] % 12];
}*/
